...
if(isset($_POST['submit']))
{
	...
	$abs = $_POST['abs'];
	$pbs = $_POST['pbs'];
	$sql="INSERT INTO `student`(`Name`, `RollNumber`, `section`, `mail`, `mobilenum`, `attendance`, `cgpa`, `abs`, `pbs`) VALUES ('$name','$rno','$sec','$mail','$num','$attendance','$CGPA','$abs','$pbs')";
...
<div class="container-xxl py-5">
                ...
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="service-item text-center pt-3">
                        <div class="p-4">
                            ...
                            <a href="delst.php"><h5 class="mb-3">DELETE STUDENT</h5></a>
                        </div>
                    </div>
                </div>
    ...
    <!-- Service End -->
<br>
	<center><h1 style="background-color:white"> ADD STUDENT DETAILS</h1></center>
	<br>
