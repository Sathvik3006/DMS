...
<center><br><h3>DEPARTMENT MANAGEMENT SYSTEM</h3></center>
<body>
    <!-- Spinner Start -->
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<br>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="club.php" class="nav-item nav-link active">club</a>
                <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">LOGIN</a>
                    <div class="dropdown-menu fade-down m-0">
                        <a href="adminlogin.html" class="dropdown-item">ADMIN</a>
                        <a href="facultylogin.html" class="dropdown-item">FACULTY</a>
                        <a href="studentlogin.html" class="dropdown-item">STUDENT</a>
                    </div>
                </div>
    ...
    <!-- Navbar End -->
<br>
	<center><h1 style="background-color:white"> CLUB INFORMATION </h1></center>
	<br>
