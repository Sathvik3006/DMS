...
if(isset($_POST['submit']))
{
	$name = $_POST['name'];
	$rno = $_POST['data'];
	$sql="INSERT INTO `club`(`Name`, `DATA`) VALUES ('$name','$rno')";
...
<br>
	<center><h1 style="background-color:white"> ADD CLUB DETAILS</h1></center>
	<br>
...
<br>
<br>
    <label for="des">DATA</label><br>
    <input type="text" id="lname" name="data" placeholder="CLUB INFORMATION">
<br>
<br>
